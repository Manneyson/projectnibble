...
class CheckoutRowView: UIView {
    ...
    var detail: String = "" {
        didSet {
            ...
            if (self.titleLabel.text == "Total") {
                self.detailLabel.textColor = UIColor.flatMint()
            }
        }
    }
    ...
    convenience init(title: String, detail: String, tappable: Bool = true, theme: STPTheme) {
        ...
        self.titleLabel.font = UIFont(name: "Avenir-Book", size: 13)
    ...
    override func layoutSubviews() {
        ...
        self.activityIndicator.frame = CGRect(x: self.bounds.maxX - (height / 1.3), y: 0,
